...
namespace aoc2019
{
    public class Pos : IEquatable<Pos>
    {
        ...
        {//this.Foo.GetHashCode() * 17 + this.Bar.GetHashCode();
...
U62,R66,U55,R34,D71,R55,D58,R83";
            Assert.AreEqual(159, closestIntersection(example1));
            string example2 = @"R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51
 U98,R91,D20,R16,D67,R40,U7,R15,U6,R7";
            Assert.AreEqual(135, closestIntersection(example2));
 ...
 U98,R91,D20,R16,D67,R40,U7,R15,U6,R7*/
        ...
        private int closestIntersection(string lines)
        {
            ...
            using (StringReader reader = new StringReader(lines))
            {
                ...
                while ((line = reader.ReadLine()) != null)
                {
                    ...
                    //Console.WriteLine(String.Join(",", posPath));
        ...
        public void Part1()
        {
            Console.WriteLine(closestIntersection(input));
            //int sum = 0;
